...
export const vfpExpandedQuestions: Record<string, Exercise[]> = {
  basic: [
    ...
    { id: 'vf-b-17', type: 'single', question: 'Visual FoxPro最后发布的主要版本是？', options: ['6.0', '7.0', '8.0', '9.0'], answer: 'D', explanation: 'Visual FoxPro 9.0是2004年发布的最后一个主要版本，微软对它的扩展支持已经结束。', score: 2, difficulty: 'basic' },
...
export const networkExpandedQuestions: Record<string, Exercise[]> = {
  ...
  exam: [
    ...
    { id: 'nw-e-6', type: 'single', question: '关于TLS与网络分层的说法，较严谨的是？', options: ['TLS只能属于物理层', 'TLS只能属于网络层', 'TLS位于应用协议与传输服务之间，不宜机械对应唯一OSI层', 'TLS就是HTTP'], answer: 'C', explanation: 'TLS为上层应用提供认证、机密性和完整性保护，通常运行在TCP之上。教学时可说明其位置，但不应把它绝对化为唯一OSI层。', score: 5, difficulty: 'exam' },
    { id: 'nw-e-7', type: 'single', question: '以下关于加密的描述，正确的是？', options: ['加密能阻止数据被截获', '正确使用加密可保护机密性，但不能替代终端安全和身份管理', '只要加密就不需要防火墙', '加密可以消除全部网络风险'], answer: 'B', explanation: '加密可以让截获者难以读取明文，并可配合完整性与认证机制；但它不能阻止截获，也不能解决终端失陷、弱口令等全部风险。', score: 5, difficulty: 'exam' },
